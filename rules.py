...
# Whitelisted road categories (ordered from minor to major)
ROAD_CATEGORIES = ['residential', 'unclassified', 'tertiary', 'secondary', 'primary', 'trunk', 'motorway']
...
def get_road_width_for_scale(road_type, scale, is_interacting, lod_roads_threshold, ignore_interaction=False):
    ...
    if scale < 0.00015:
        base_widths = {'motorway': 1.5, 'trunk': 1.0, 'primary': 0.0, 'secondary': 0.0, 'tertiary': 0.0, 'unclassified': 0.0, 'residential': 0.0}
    elif scale < 0.0004:
        base_widths = {'motorway': 2.0, 'trunk': 1.5, 'primary': 1.0, 'secondary': 0.0, 'tertiary': 0.0, 'unclassified': 0.0, 'residential': 0.0}
    elif scale < 0.0012:
        base_widths = {'motorway': 2.5, 'trunk': 2.0, 'primary': 1.5, 'secondary': 1.0, 'tertiary': 0.8, 'unclassified': 0.0, 'residential': 0.0}
    elif scale < 0.004:
        base_widths = {'motorway': 3.5, 'trunk': 3.0, 'primary': 2.5, 'secondary': 1.8, 'tertiary': 1.2, 'unclassified': 1.0, 'residential': 0.0}
    elif scale < 0.015:
        base_widths = {'motorway': 5.0, 'trunk': 4.5, 'primary': 3.5, 'secondary': 2.5, 'tertiary': 2.0, 'unclassified': 1.5, 'residential': 1.0}
    else:
        base_widths = {'motorway': 7.0, 'trunk': 6.0, 'primary': 5.0, 'secondary': 4.0, 'tertiary': 3.0, 'unclassified': 2.5, 'residential': 1.5}
